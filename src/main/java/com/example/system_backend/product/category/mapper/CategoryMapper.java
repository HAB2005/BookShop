...
/**
 * Maps Category entities to CategoryResponse DTOs. Handles complex mapping
 * logic including recursive children mapping.
 */
@Component
...
public class CategoryMapper {
         ...
         * tree. This method performs true recursion to build complete category
         * tree.
         */
        ...
        /**
         * Map Category entity to CategoryResponse DTO with provided children (1
         * level only). Used when children are already fetched to avoid N+1 queries.
         */
        ...
        /**
         * Map Category entity to CategoryResponse DTO without children. Used for
         * simple mapping scenarios.
         */
        ...
        /**
         * Build tree structure from flat list of categories. Efficient tree
         * building without recursive queries.
         */
